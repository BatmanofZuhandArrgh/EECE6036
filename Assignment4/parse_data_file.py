...
if __name__ == "__main__":
    ...
    with open(f'./dataset/01234train_2000imgs.txt', 'w') as f:
        f.write(''.join(train_imgs))
    with open(f'./dataset/01234train_2000labs.txt', 'w') as f:
        f.write('\n'.join(train_labels))

    with open(f'./dataset/01234test_500imgs.txt', 'w') as f:
        f.write(''.join(test_imgs))
    with open(f'./dataset/01234test_500labs.txt', 'w') as f:
        f.write('\n'.join(test_labels))
    
    
    # testing_sample = read_img_from_txt('./dataset/01234test_500imgs.txt')
    ...
    for num in range(5, 10):
        ...
        test_imgs.extend(str_data)
        test_labels.extend([str(num) for x in range(500)])

    with open(f'./dataset/56789test_2500imgs.txt', 'w') as f:
        f.write(''.join(test_imgs))
    with open(f'./dataset/56789test_2500labs.txt', 'w') as f:
        f.write('\n'.join(test_labels))
